...
> ⚠️ **역사 문서:** 현재 구현 상태와 다음 작업은
> [`HANDOFF_2026-08-03_QSP7_통합연구시스템.md`](./HANDOFF_2026-08-03_QSP7_통합연구시스템.md)를 우선한다.
> 이 문서의 P1 손절 스윕은 당시 가설이며, 현재 시스템에서는 거래 경로·매도 DSL replay·공식 design/OOS gate를 거쳐 검증해야 한다.
