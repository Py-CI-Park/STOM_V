...
| 레인 우선순위 | **tick 먼저**(백테 8분, 표본 12만 건) → min 나중 |
| 기간 | 3~3.5일 (엔진 1.5일 + 화면 1일 + 세대 루프 4시간 + 보고 0.5일) |
| 기대/한계 | 표본밖 건당 −5,250 → **−4,400원대(약 15% 손실 축소)**. **흑자 전환은 안 된다** |
...
| 자산 | 값 |
|---|---|
| **tick 설계 control** | job `20260803_193432_..._72661` · CSV `stock_bt_ResearchTest_Tick_B_090000_092800_Wide_20260419_20260803194251.csv` · 120,118건 · −616,453,677원 |
| **tick 표본밖 control** | job `20260803_193437_..._77265` · CSV `..._20260803194928.csv` · 82,290건 · −432,017,233원 |
...
| 레인 manifest | tick: 설계 2022-04-01~2024-03-31 / OOS 2024-04-01~2026-02-27 · 세션 090000~092800<br>min: 설계 2025-04-07~2025-11-28 / OOS 2025-12-01~2026-02-27 · 세션 090000~152800 |
...
| 단계 | 산출물 | 완료 게이트 | 예상 |
|---|---|---|---|
| **G-0a** | `ai_strategy_loop/autopsy/loss_profile.py`<br>10분위·형태 6종·홀드아웃 검증·2D 포켓·Welch t + BH-FDR | 합성 6형태 분류 100% · 고립 1칸 제외 · 무작위 라벨에서 포켓 0건 | 0.5일 |
...
| **G-0c** | 페이지 17~20 + 8b/11 강화 + API 5종 | JSX PASS · 한국어 안내 · 예산 게이지 · 재유입 편향 배지 | 1일 |
| **G-1~G-4** | tick 세대 루프 | 세대별 표본밖 동반 개선 · 예산 준수 | 세대당 ~50분 |
...
- G-0a: ai_strategy_loop/autopsy/loss_profile.py
  (10분위·형태 6종·홀드아웃 검증·2D 포켓·Welch t + BH-FDR)
...
- G-0c: 페이지 17~20 신설 + 8b·11 강화 + API 5종
- G-1~G-4: tick 세대 루프(세대당 후보 3~4개, 백테 약 50분)
- G-5: rounds/G_tick_*.md 보고서 + 문서·원장 갱신

절대 규율:
- 설계·홀드아웃 양쪽 손실 구간만 제거, 고립 1칸 금지(연속 2칸 이상)
- 임계는 분위 격자 위에서만, 임의 미세조정 금지
- 누적 유지율 40% 하한(설계·표본밖 중 낮은 쪽), 1세대 25%p·이후 12%p 배분
...
재사용할 자산(재생성 금지):
- tick 설계 job 20260803_193432_..._72661 / 표본밖 job 20260803_193437_..._77265
- min 설계 job 20260803_191118_..._78453 / OOS job 20260803_191126_..._86231
- min 분석 tp-58491917e7144717 (sidecar 복원)
- 레인 manifest(ai_strategy_loop/dashboard/lane_manifest.py)
- 기존 엔진: loss 관련 신규 모듈 외에는 autopsy/recovery_insight.py,
  revision/buy_filter_proposer.py, hier_ast.parse_leaves_flexible,
  dashboard/trade_path_official_api.py(axis 모드) 를 재사용
