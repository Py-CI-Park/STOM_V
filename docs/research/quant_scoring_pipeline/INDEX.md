...
> 갱신일: 2026-08-24 · **새 세션은 반드시 여기서 시작한다.**
...
| 순서 | 문서 | 내용 |
|---:|---|---|
| **최신 1** | **`HANDOFF_2026-08-24_process_research_pipeline_재출발.md`** | **★ 최신 실행 핸드오프** — `f75b80eb` 통합·`codex/process-research-pipeline-restart`·첫 착수 `PIPE-01 <3000 10건 실패 원장` |
| **최신 2** | **`2026-08-24_process_research_pipeline_재출발_대시보드_연구_성숙화_마스터플랜.md`** | **최신 계획 정본** — 페이지별 UX/UI·AnalysisBundle v2·제품/연구 분리·G0→부검→G1 종단 슬라이스·성숙도 Gate |
