...
| 순서 | 문서 | 내용 |
|---:|---|---|
| **최신 1** | **`2026-08-26_SYS-01B_legacy_truth_adapter_API_구현결과.md`** | **★ 최신 구현 정본** — exact terminal receipt·legacy adapter·REST/WS parity·PIPE-01 adapter 집계 2/0/6/2·다음 UX-01 |
| **최신 2** | **`2026-08-25_SYS-01A_Research_Truth_Contract_구현결과.md`** | **Truth 계약 정본** — strict 4축 계약·PIPE-01 10/10 fixture·복합 identity·fail-closed validator |
| **최신 3** | **`2026-08-25_BOOT-01_PIPE-01_환경사전점검과_LT3000_실패원장.md`** | **최신 증거 정본** — BOOT-01 환경 GO/NO-GO·`<3000` 10/10 원시 증거 대조·정상 무거래 0/실행 실패 8 정정 |
| **최신 4** | **`HANDOFF_2026-08-24_process_research_pipeline_재출발.md`** | **최신 실행 핸드오프** — PIPE-01/SYS-01A/SYS-01B 완료·UX-01 재개 지점 |
| **최신 5** | **`2026-08-24_process_research_pipeline_재출발_대시보드_연구_성숙화_마스터플랜.md`** | **최신 계획 정본** — 페이지별 UX/UI·AnalysisBundle v2·제품/연구 분리·G0→부검→G1 종단 슬라이스·성숙도 Gate |
