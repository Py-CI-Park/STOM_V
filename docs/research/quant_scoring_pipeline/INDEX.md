...
| 순서 | 문서 | 내용 |
|---:|---|---|
| **최신 0** | **`2026-08-29_ANA-04_Failure_Autopsy_구현결과.md`** | **★ 분석 최신 정본** — 7후보·5Family·28Fold·Exit 공통 실패·후보 근거·620 table red→green |
| **최신 0.1** | **`HANDOFF_2026-08-29_ANA-04_완료.md`** | **★ 재개 정본** — ANA-04 구현 SHA·병합 순서·UX-05 현재/역사 분리·금지 경계 |
| **최신 0.2** | **`2026-08-28_UX-04_Mission_Control_구현결과.md`** | **UX-04 정본** — 정상 중단·이유·허용 행동·Roadmap·상세 접힘 |
| **최신 0.3** | **`HANDOFF_2026-08-28_UX-04_완료.md`** | **직전 핸드오프** — ANA-04 완료 핸드오프가 재개 지점을 대체 |
| **최신 0.4** | **`2026-08-28_UX-03_G0_G1_Decision_Gateboard_구현결과.md`** | **UX-03 정본** — 봉인 API·게이트보드·플랫폼 28/28와 경제 0/7 STOP 분리 |
| **최신 0.5** | **`HANDOFF_2026-08-26_UX-03_중간점검.md`** | **과거 핸드오프** — 최신 ANA-04 핸드오프를 사용 |
