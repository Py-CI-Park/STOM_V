...
| 순서 | 문서 | 내용 |
|---:|---|---|
| **최신 1** | **`2026-08-25_BOOT-01_PIPE-01_환경사전점검과_LT3000_실패원장.md`** | **★ 최신 실행 정본** — BOOT-01 환경 GO/NO-GO·`<3000` 10/10 원시 증거 대조·정상 무거래 0/실행 실패 8 정정·다음 SYS-01A |
| **최신 2** | **`HANDOFF_2026-08-24_process_research_pipeline_재출발.md`** | **최신 실행 핸드오프** — `f75b80eb` 통합·재출발 branch·PIPE-01 완료·SYS-01A 재개 지점 |
| **최신 3** | **`2026-08-24_process_research_pipeline_재출발_대시보드_연구_성숙화_마스터플랜.md`** | **최신 계획 정본** — 페이지별 UX/UI·AnalysisBundle v2·제품/연구 분리·G0→부검→G1 종단 슬라이스·성숙도 Gate |
