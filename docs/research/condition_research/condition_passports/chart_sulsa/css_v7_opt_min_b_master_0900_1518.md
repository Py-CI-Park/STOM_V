# Condition Passport — CSS_V7_OPT_MIN_B_MASTER_0900_1518

| Field | Value |
|---|---|
| condition_id | `CSS_V7_OPT_MIN_B_MASTER_0900_1518` |
| human_name | `1분봉 최적화형 매수식` |
| role | `hypothesis_seed` |
| lane | `min` |
| side | `buy` |
| principle_ids | `P3, P4, P5, P9, P13` |
...
| source | `chart_sulsa_v7_0` (원문 6.4절) |

## Core hypothesis

이 passport는 차트술사 구조론 보고서 v7.0에서 추출한 **무근거 가설 시드**다.
관련 원리: P3, P4, P5, P9, P13. 이 조건식 자체는 `buy` 측이며, 반대 측 코드는 같은 레인의
