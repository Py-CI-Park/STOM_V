# Condition Passport — ProfitLead_TrailKeep070_2025Comparator
...
| buy_strategy_id | `GATE_rr8_21_trail_keep_0_7_B` |
| sell_strategy_id | `GATE_rr8_21_trail_keep_0_7_S` |
| buy_code_sha256 | `157b58b0f7618de11f52d534e5f7c61b28bf11e7404ef3885dc4d52ab2da2099` |
| sell_code_sha256 | `01a1673baf10ebfe502f25cfbf8f37f683cc0805676f4a4b795d6860a45da9ef` |
| prior_profit | `3089180` |
| prior_mdd | `18.84` |
| prior_trades | `165` |
...
if 등락율 > 29.5:
    ...
    if 수익률 >= 9 or 수익률 <= -5.0:
        매도 = True
    elif 최고수익률 > 3 and 최고수익률 * 0.7 >= 수익률:
        매도 = True
    elif 시가총액 < 10000:
