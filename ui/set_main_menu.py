...
class SetMainMenu:
    ...
    def set(self):
        ...
        self.ui.kp_pushButton = self.wc.setPushbutton('P', color=6, click=self.ui.ShowKimp,           shortcut='Alt+P', animated=True, tip='김프')
        ...
        self.ui.js_pushButton = self.wc.setPushbutton('K', color=6, click=self.ui.ShowJisu,           shortcut='Alt+K', animated=True, tip='지수차트')
