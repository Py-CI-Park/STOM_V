...
class SetMainMenu:
    ...
    def set(self):
        ...
        self.ui.sf_pushButton.setGeometry(5, 430, 35, 15)
        self.ui.bb_pushButton.setGeometry(8, 450, 16, 15)
        self.ui.ds_pushButton.setGeometry(23, 450, 16, 15)
        self.ui.od_pushButton.setGeometry(8, 470, 16, 15)
        self.ui.zz_pushButton.setGeometry(23, 470, 16, 15)

        self.ui.cl_pushButton.setGeometry(5, 490, 35, 15)
        self.ui.bd_pushButton.setGeometry(8, 510, 16, 15)
        self.ui.ad_pushButton.setGeometry(23, 510, 16, 15)

        self.ui.progressBarrr.setGeometry(6, 530, 35, 227)
