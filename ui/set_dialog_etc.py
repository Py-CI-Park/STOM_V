...
class SetDialogEtc:
    ...
    def set(self):
        ...
        self.ui.bjs_checkBoxxx_03 = self.wc.setCheckBox('순매수금액', self.ui.bjs_groupBoxxx_01, style=style_ck_bx, changed=self.ui.SettingStockWeightCotrolChanged)
        ...
        self.ui.bjc_checkBoxxx_03 = self.wc.setCheckBox('순매수금액', self.ui.bjc_groupBoxxx_01, style=style_ck_bx, changed=self.ui.SettingCoinWeightCotrolChanged)
