...
def cz_button_clicked_01(ui):
    if ui.cvj_pushButton_01.isVisible():
        ...
        ui.cs_textEditttt_02.setVisible(visible)
        ui.czoo_pushButon_02.setVisible(visible)
    else:
        if ui.czoo_pushButon_01.text() == '확대(esc)':
            visible = False
            ui.czoo_pushButon_01.setText('축소(esc)')
        ...
        ui.cs_textEditttt_04.setVisible(visible)
        if ui.cva_pushButton_01.isVisible():
            ui.cs_textEditttt_06.setVisible(visible)
        else:
            ui.cs_textEditttt_05.setVisible(visible)
        ui.czoo_pushButon_02.setVisible(visible)
...
def cz_button_clicked_02(ui):
    if ui.cvj_pushButton_01.isVisible():
        ...
        ui.cs_textEditttt_01.setVisible(visible)
        ui.czoo_pushButon_01.setVisible(visible)
    else:
        if ui.czoo_pushButon_02.text() == '확대(esc)':
            visible = False
            ui.czoo_pushButon_02.setText('축소(esc)')
        ...
        ui.cs_textEditttt_03.setVisible(visible)
        if ui.cva_pushButton_01.isVisible():
            ui.cs_textEditttt_06.setVisible(visible)
        else:
            ui.cs_textEditttt_05.setVisible(visible)
