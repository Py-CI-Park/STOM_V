...
from utility.static import GetUvilower5, dt_ymdhms, GetIndicator, GetHogaunit
        ...
        if self.opti_turn == 1:
            for vturn in self.trade_info:
                ...
                for vkey in self.trade_info[vturn]:
                    ...
                    gubun = self.CheckBuyOrSell(보유중, 현재가, 매수분할횟수, 매수호가, 매도호가, 관심종목, vturn, vkey, 분봉저가=분봉저가, 분봉고가=분봉고가)
