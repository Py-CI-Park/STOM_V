...
from utility.static import now, now_utc, GetUpbitHogaunit, GetUpbitPgSgSp, get_buy_indi_stg, get_logger, dt_ymdhms, \
    get_ema_list, get_angle_cf, dt_ymdhm
...
class UpbitStrategyTick:
    ...
    def _체결강도급등및호가상승압력(self, tick1, ratio1=1.1, tick2=30, ratio2=0.7):
        return self._체결강도급등(tick1, ratio1) and self._호가상승압력(tick2, ratio2)

    def _체결강도급락및호가하락압력(self, tick1, ratio1=0.9, tick2=30, ratio2=0.3):
    ...
    def _이평기반_동적청산(self, short, long=60, deviation1=1.0, deviation2=1.0):
