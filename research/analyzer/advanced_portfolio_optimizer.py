...
class AdvancedPortfolioOptimizer:
    ...
    def optimize_portfolio(self, returns: pd.DataFrame, method: str = 'sharpe') -> Dict:
        ...
        # 목적 함수
        if method == 'sharpe':
            objective = lambda x: -self.calculate_portfolio_metrics(returns, x)['sharpe_ratio']
        elif method == 'min_variance':
            objective = lambda x: self.calculate_portfolio_metrics(returns, x)['volatility']
        elif method == 'max_return':
            objective = lambda x: -self.calculate_portfolio_metrics(returns, x)['return']
    ...
    def calculate_portfolio_attribution(self, returns: pd.DataFrame, 
