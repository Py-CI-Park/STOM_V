...
function V4SettingsTab({ baseUrl, dashVersion }) {
  ...
  return <section className="v4-settings" aria-labelledby="v4-settings-heading"><h2 id="v4-settings-heading" className="panel-hd-title">설정 · 대시보드 관리</h2>
    ...
    <div className="panel"><div className="panel-hd"><div className="panel-hd-title"><span className="dot" />Governance</div></div><div className="panel-bd"><p className="v4s-note">연구 시작, 게이트, export 및 human 승인 계약은 Live 탭 소유이며 여기서 변경할 수 없습니다.</p></div></div>
  </section>;
}
