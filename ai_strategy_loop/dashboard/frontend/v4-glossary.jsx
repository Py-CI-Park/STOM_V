...
const _V4G_SECTIONS = [
  ...
  },
  {
    ...
    rows: [
      ...
      ["internal_validation_split", "연속 1회 런을 설계/후반으로 나눈 내부 검증 분할 — 자본이 이어지므로 독립 OOS 가 아니다."],
      ["graduation_validation", "train 게이트 통과 후보의 졸업검사(과적합 방어 신호). 승격 권한은 없다."],
      ["FROZEN_OOS_HOLDOUT", "봉인된 최종 OOS — 사람 승인 후에만 개봉하며 현재 프로그램에는 사용 금지."],
