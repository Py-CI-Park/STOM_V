...
const DEFAULT_CONFIG_SPEC = [
  ...
  { name: "model", label: "모델", type: "select", default: "gpt-5.6-sol", group: "AI",
    options: ["gpt-5.6-sol", "gpt-5.6-luna", "gpt-5.6-terra", "gpt-5.5", "gpt-5.5-mini", "openai-codex/gpt-5.5"],
    help: "GPT 5.6-sol 기본. xhigh는 reasoning_effort로 표시." },
