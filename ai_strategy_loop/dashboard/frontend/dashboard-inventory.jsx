...
const DASHBOARD_PAGE_OWNER_MATRIX = [
  { key: "research", label: "Live", full: "Live", badge: "LIVE", hint: "조건식 자율 진화 · 실시간 관찰", owner: "운영 루프", owns: "실시간 생성·백테스트·채점 루프와 승인 대기 관찰; Alpha prototype 표식", notOwner: "히스토리 거버넌스·후보 비교·운용 결정 이력", primarySurface: "V4ResearchLive", emptyState: "진화 시작 전 안내와 설정 열기", legacyAliases: ["evolution"], internalAliases: ["process"], prototypeAliases: ["alpha"] },
