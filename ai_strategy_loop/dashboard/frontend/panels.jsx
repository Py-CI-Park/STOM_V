/* Reusable small panels — THIN BARREL (P5.9 decomposition of the former 910-line panels.jsx).
   14개 패널을 관심사별 3개 sibling 으로 분해하고, 이 파일은 배럴로 남아 동일한 window 전역
   재노출 + 동일한 14-심볼 ESM export 표면을 유지한다(소비처 app.jsx · 엔트리 무수정).
     ...
     · panels-analysis.jsx = AutopsyPanel · LineagePanel · HoldoutPanel · CostPanel · FeedbackPanel
...
import { AutopsyPanel, LineagePanel, HoldoutPanel, CostPanel, FeedbackPanel } from "./panels-analysis.jsx";
