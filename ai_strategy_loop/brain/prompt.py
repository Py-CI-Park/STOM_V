    ...
    *,
    ...
    Args:
        ...
        classification_generation_enabled: True면(매수 경로) 3개 분류축(①시가총액 구분
            ②등락률 구분 ③넓은 시간창 09:00~09:28)에서 매 세대 일관된 니치를 의도적으로
    ...
    if kind == "buy":
        ...
        #   등락률 국면·넓은 시초 시간창(09:00~09:28)에서 먼저 니치를 고르도록 유도한다.
        ...
        if classification_generation_enabled:
            user_lines.append(
                ...
                "구간(09:00~09:28)에서 한 시간대를 의도적으로 선택하라 — 시초 급등(09:00~09:05)·"
                "안정화(09:05~09:15)·후반(09:15~09:28). 고른 시간대의 수급 특성에 맞춰 진입하라.\n"
