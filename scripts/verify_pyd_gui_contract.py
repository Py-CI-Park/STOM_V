...
def pyd_mainwindow_backtest_parity_failures() -> list[str]:
    ...
    required_snippets = {
        ...
        "chart current code state": "self.ctpg_code             = None",
        "chart trading state": "self.trading          = False",
        "treemap canvas state": "self.canvas  = None",
        "queue sagent qsize state": "self.saqsize = 0",
        ...
        "dialog event filter install": "dialog.installEventFilter(self)",
        "dialog move position save": "QEvent.Move",
        "mainwindow event filter position hook": "self.HandlePydDialogPositionEvent(widget, event)",
